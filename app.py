...
- After covering all four dichotomies, present the overall 'team type' based on the most common traits (e.g., INFJ, etc).
- Provide an analysis of the overall team type, including key characteristics and how it influences team dynamics.
- **Only use the TypeFinder types provided; do not introduce new types.**
...
- Begin with an **TypeFinder Type Breakdown**: Present a percentage breakdown of each TypeFinder type within the team (only include TypeFinder types present among the team members).
- Ensure calculations are accurate based on the team size and TypeFinder types provided.
...
- For each TypeFinder dimension (Extraversion vs. Introversion, Sensing vs. Intuition, Thinking vs. Feeling, Judging vs. Perceiving):
  - Calculate the team's percentage distribution based on the TypeFinder types of the team members provided.
...
# Define the list of TypeFinder types (formerly MBTI types)
